...
const secretKeyAdmin = "adminLogin001";
const secretKeyUser = "userLogin003";

const generateJwtAdmin = (user) => {
  const payload = {username: user.username, } // no need of password here as username is unique key
